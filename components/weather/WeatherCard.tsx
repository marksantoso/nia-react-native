...
export const WeatherCard = ({ weather, onPress, style }: WeatherDetailsProps) => {
    ...
    return (
        <Card style={[styles.card, style]} onPress={onPress}>
            <View style={[styles.indexIndicator, { backgroundColor: weather.index.color }]} />
            <ThemedText style={styles.indexTitle}>Weather</ThemedText>
            <ThemedText style={styles.dateText}>{formatDate(weather.datetime)}</ThemedText>
            <View style={styles.weatherMain}>
                ...
                <ThemedText style={styles.indexValue}>{weather.index.value.toFixed(1)}{weather.parameters.temperature.unit}</ThemedText>
            </View>
