...
export function CityCard({ city }: CityCardProps) {
    ...
    useEffect(() => {
        if (weatherData) {
            ...
            updateCity(city.id, 'precipitation', weatherData.parameters.precipitations.value);
        }
    }, [weatherData]);
            ...
            >
                <View style={styles.temperatureContainer}>
                    ...
                    <Text style={styles.temperatureText}>
                        {weatherData.index.value.toFixed(1)}
                        {weatherData?.parameters?.apparent_temperature?.unit}
                    </Text>
                </View>
            </ImageBackground>
