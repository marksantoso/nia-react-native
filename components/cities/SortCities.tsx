...
import { NumericSortBy, SORT_BY, SORT_ORDERS, SortOrder } from './types/sort.types';
...
export function SortCities() {
    ...
    const { cities, filteredSortedCities, setFilteredSortedCities } = useCitiesStore();

    const handleFilteredCitiesChange = useCallback((filteredCities: City[]) => {
